...
<body class="font-['Arial',sans-serif] bg-white m-0 flex flex-col min-h-screen">
    ...
    <div class="flex justify-center">
        <form action="{{ route('superadmin.crearInstructor') }}" method="POST"
            class="bg-white m-4 p-2 rounded-lg shadow-[0_0_10px_rgba(0,0,0,0.8)] border-[#2F3E4C] w-2/3 items-center">
            <div class="p-6 bg-gray-100 rounded-lg">
                @csrf
                <div class="mb-6 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-40 h-40 m-4 mx-auto text-gray-500">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full border border-gray-300 rounded-lg p-2.5"
                            placeholder="Cédula" name="identification">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full border border-gray-300 rounded-lg p-2.5"
                            placeholder="Celular" name="telephone">
                    </div>
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full border border-gray-300 rounded-lg p-2.5"
                            placeholder="Municipio" name="municipality">
                    </div>
                ...
                <div class="flex justify-end mt-6 space-x-4">
                    <button type="submit"
                        class="px-4 py-2 text-white bg-green-700 rounded hover:bg-green-900">Confirmar</button>
                    <a href="{{ route('superadmin.SuperAdmin-Instructor') }}"
